...
import {
  ...
  render_lose_message,
  render_3_cards,
  render_players_buttons,
  renderwinner,
  render_no_selectedcards,
  render_3_cards_button,
} from "./render.js"
...
export function is_Set(selectedcards) {
  if (
    selectedcards[0].classList[1] === selectedcards[1].classList[1] &&
    selectedcards[1].classList[1] === selectedcards[2].classList[1] &&
    selectedcards[0].classList[1] === selectedcards[2].classList[1] &&
    selectedcards[0].classList[2] === selectedcards[1].classList[2] &&
    selectedcards[1].classList[2] === selectedcards[2].classList[2] &&
    selectedcards[0].classList[2] === selectedcards[2].classList[2] &&
    selectedcards[0].classList[3] === selectedcards[1].classList[3] &&
    selectedcards[1].classList[3] === selectedcards[2].classList[3] &&
    selectedcards[0].classList[4] === selectedcards[1].classList[4] &&
    selectedcards[1].classList[4] === selectedcards[2].classList[4] &&
    selectedcards[0].classList[4] === selectedcards[2].classList[4]
  ) {
    return true
  } else if (
    selectedcards[0].classList[1] != selectedcards[1].classList[1] &&
...
function handleStartGame() {
  ...
  document.getElementById("no_remaining_cards").classList.remove("d-none")
}
